-- Run this ENTIRE file from line 1 in Supabase SQL Editor (not just the bottom).

-- ── Create tables first (team may not exist yet) ─────────────────────────────
...
-- Patch existing Bolt tables (add columns if table existed without them)
...
-- Grants (required — without these the app gets 401 Access blocked)
